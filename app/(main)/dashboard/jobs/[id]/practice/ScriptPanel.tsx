...
export function ScriptPanel({script, jobId, userId}: ScriptPanelProps) {
    ...
    return (
        <Card
            className="w-full sm:w-80 bg-gradient-to-b from-background to-muted/50 border-0 shadow-2xl h-full overflow-y-auto flex flex-col">
            <div
                className="sticky top-0 z-10 bg-background/90 backdrop-blur px-4 py-2 flex items-center justify-between border-b border-border">
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Are you sure you want to regenerate the script? This will create
                                a new version with updated content.
                            </DialogDescription>
                        </DialogHeader>
