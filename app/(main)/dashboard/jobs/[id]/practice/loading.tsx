                    ...
                    <Card className="bg-gradient-to-b from-background to-muted/50 border-0 shadow-2xl h-full flex-1">
                        <div className="relative flex flex-col min-h-[calc(100vh-12rem)] w-full overflow-hidden">
                            <div className="flex-1 w-full flex items-center justify-center relative px-3 py-6 sm:p-8">
                                {/* Participants Grid */}
                                <div
                                    className="flex flex-col sm:grid sm:grid-cols-2 gap-4 sm:gap-8 w-full max-w-5xl relative z-10">
                                    {/* AI Participant Card Skeleton */}
                                    <Card
                                        className="bg-gradient-to-b from-[#171532] to-[#08090D] border-2 relative overflow-hidden">
                                        <div className="p-4 sm:p-6">
                                            <div className="flex flex-col items-center">
                                                <div className="relative">
                                                    <div
                                                        className="bg-gradient-to-l from-[#FFFFFF] to-[#CAC5FE] rounded-full p-1 relative mb-3 sm:mb-4">
                                                        <Skeleton
                                                            className="size-24 sm:size-32 md:size-40 rounded-full"/>
                                                    </div>
                                                </div>
                                    ...
                                    <Card
                                        className="bg-gradient-to-b from-[#1A1C20] to-[#08090D] border relative overflow-hidden">
                                        <div className="p-4 sm:p-6">
                                            <div className="flex flex-col items-center">
                                                <div className="relative">
                                                    <Skeleton
                                                        className="size-24 sm:size-32 md:size-40 rounded-full mb-3 sm:mb-4"/>
                                                </div>
                                                <Skeleton className="h-6 w-32 mt-2"/>
                                                <Skeleton className="h-4 w-20 mt-1"/>
                                            </div>
                            ...
                            <div
                                className="fixed bottom-4 sm:bottom-6 left-3 right-3 sm:left-1/2 sm:-translate-x-1/2 z-30">
                                <div
                                    className="flex items-center justify-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-full bg-background/80 backdrop-blur-sm border shadow-lg max-w-md mx-auto">
