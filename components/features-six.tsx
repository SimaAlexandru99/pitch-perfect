        ...
        <div className="mx-auto w-full max-w-5xl px-6">
          <div>
            <h2 className="text-foreground max-w-2xl text-balance text-4xl font-semibold">
              Unlock your sales potential with AI-driven voice training
            </h2>
          </div>
          <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card variant="soft" className="overflow-hidden p-6">
              ...
              <h3 className="text-foreground mt-5 text-lg font-semibold">
                Realistic AI Sales Calls
              </h3>
              <p className="text-muted-foreground mt-3 text-balance">
                Practice real-world sales conversations with lifelike AI clients
            ...
            <Card variant="soft" className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Receive actionable feedback and performance scores after every
                call to accelerate your growth.
              </p>
            ...
            <Card variant="soft" className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Sharpen your skills by practicing responses to tough objections
