...
const JobCard = async ({
  ...
  return (
    <Card className="relative w-full max-w-xs min-h-96 flex flex-col justify-between shadow-lg border border-border rounded-xl bg-card transition-transform hover:-translate-y-1 hover:shadow-2xl duration-200">
      {/* Level Badge */}
      <div
        className={cn(
      ...
      <div className="flex justify-center mt-6">
        {DomainIcon ? (
          ...
          <div className="rounded-full ring-2 ring-primary shadow-md object-cover size-[90px] bg-muted flex items-center justify-center text-3xl text-muted-foreground">
            ?
          </div>
        )}
      </div>
